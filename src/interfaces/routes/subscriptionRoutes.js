...
export const setupSubscriptionRoutes = (app, { prismaRepository, userRepository }) => {
  ...
  registerProtectedRoute(app, '/api/subscriptions', async (protectedApp) => {
    ...
    protectedApp.post('/admin/plans', (req, res) => subscriptionController.createPlan(req, res));
    protectedApp.put('/admin/plans/:planId', (req, res) => subscriptionController.updatePlan(req, res));
    protectedApp.patch('/admin/plans/:planId/visibility', (req, res) => subscriptionController.togglePlanVisibility(req, res));
    protectedApp.get('/admin/subscriptions', (req, res) => subscriptionController.getSubscriptions(req, res));
    protectedApp.get('/admin/subscriptions/:subscriptionId', (req, res) => subscriptionController.getSubscriptionById(req, res));
    protectedApp.post('/admin/subscriptions/:subscriptionId/cancel', (req, res) => subscriptionController.adminCancelSubscription(req, res));
    protectedApp.get('/admin/transactions', (req, res) => subscriptionController.getAdminTransactions(req, res));
  }, {
    prismaRepository,
    userRepository
  });
